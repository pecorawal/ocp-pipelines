...
func initCloudsObject() {
	Clouds = []Cloud{
		...
		Cloud{Id: "5", Title: "NewCloud", Desc: "New Cloud", Content: "New cloud computing is a set of cloud computing services for business offered by the information technology company IBM CO."}
	}
}
