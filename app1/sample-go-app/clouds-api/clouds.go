...
func initCloudsObject() {
	Clouds = []Cloud{
		Cloud{Id: "100", Title: "AWS Cloud Provider", Desc: "Amazon Web Services", Content: "Amazon Web Services, Inc. is a subsidiary of Amazon providing on-demand cloud computing platforms and APIs to individuals, companies, and governments, on a metered pay-as-you-go basis."},
		...
		Cloud{Id: "5", Title: "My Own Cloud", Desc: "Pecs Cloud", Content: "Pecs cloud computing is a set of cloud computing services for business offered by the information technology."},
	}
}
